...
# Remove the existing STATIC_ROOT setting to avoid conflicts.
# STATIC_ROOT = os.path.join(BASE_DIR, 'static')

# Instead, use the previously defined STATIC_ROOT:
...
AWS_STORAGE_BUCKET_NAME = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
